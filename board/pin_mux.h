...
#define BOARD_INITDEBUG_UARTPINS_SW2_GPIO GPIOD                /*!<@brief GPIO peripheral base pointer */
#define BOARD_INITDEBUG_UARTPINS_SW2_GPIO_PIN_MASK (1U << 11U) /*!<@brief GPIO pin mask */

/* Symbols to be used with PORT driver */
#define BOARD_INITDEBUG_UARTPINS_SW2_PORT PORTD                /*!<@brief PORT peripheral base pointer */
#define BOARD_INITDEBUG_UARTPINS_SW2_PIN 11U                   /*!<@brief PORT pin number */
#define BOARD_INITDEBUG_UARTPINS_SW2_PIN_MASK (1U << 11U)      /*!<@brief PORT pin mask */
                                                               /* @} */
